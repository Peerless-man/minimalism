		...
		>
			<CatalogContext.Provider value={{ logShow }}>
				...
				<div className={`${classes.body} p-5 mt-8`}>
					{menuShow && (
						<div
							className={`sm:fixed md:sticky top-0 py-2 sm:w-[60%] md:w-[25%] h-[calc(100vh-45px)] bg-transparent  z-40 overflow-auto`}
						>
							<MinimalismMenu
					...
					<div className="w-[100%] h-[calc(100vh-45px)] overflow-auto sm:py-5 md:py-2   rounded-lg">
						{children}
					</div>
				</div>
